...
export function renderInquiryForm(d,{action='',stepAction='',token='',utm={},preview=false,step='contact',values={},reviewToken='',error='',measurement=null,measurementConsent=false}={}) {
 ...
 const choice=measurement?`<label class="consent"><input type="checkbox" name="measurement_consent" value="yes"${measurementConsent?' checked':''}>${e(measurementDisclosure(d.brand,measurement.platform))}${privacy(d)}</label>`:'';

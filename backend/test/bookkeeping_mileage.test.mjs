...
test.before(async()=>{
 ...
 for(const f of ['20260925015926_bookkeeping_foundation.sql','20260925055030_bookkeeping_mileage.sql'])await db.exec(await readFile(new URL('../../supabase/migrations/'+f,import.meta.url),'utf8'));

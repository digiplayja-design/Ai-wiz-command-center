...
const env={KORLIX_META_CONTROLS_ENABLED:'true',KORLIX_META_CREATE_PAUSED_ENABLED:'true',KORLIX_META_ENABLED:'true',KORLIX_META_APP_ID:'1234567',KORLIX_META_APP_SECRET:'fixture-secret-not-real',KORLIX_META_LOGIN_CONFIG_ID:'7654321',KORLIX_META_TOKEN_KEY:Buffer.alloc(32,7).toString('base64'),KORLIX_META_REDIRECT_URI:'https://example.com/api/funnels/meta/callback',KORLIX_FUNNEL_PUBLIC_BASE_URL:'https://example.com'};
...
test.before(async()=>{
 ...
 for(const file of ['20260923162339_funnel_meta_radius.sql','20260923180917_funnel_meta_locations.sql','20260923232651_funnel_meta_paused_create.sql','20260924000946_funnel_meta_controls.sql'])await db.exec(await readFile(new URL('../../supabase/migrations/'+file,import.meta.url),'utf8'));
...
Object.assign(provider,{
 ...
 inspectCreatedMeta:async()=>{providerCalls++;return graphHook?graphHook():graph();},
